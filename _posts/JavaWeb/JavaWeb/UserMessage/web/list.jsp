...
<div class="container">
    ...
    <div style="float: right;float: bottom; margin: 2px">
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <li>
                    ...
                    <a href="${pageContext.request.contextPath}/findUserByPageServlet?currentPage=${userPageBean.currentPage -1}&rows=5&name=${condition.name[0]}&address=${condition.address[0]}&email=${condition.email[0]}"
                       aria-label="Previous">
